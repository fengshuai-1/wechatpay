...
void rtc_configuration(void)
{
    ...
    /* SET LXTAL drive_capability*/
    rcu_lxtal_drive_capability_config(RCU_LXTAL_MED_HIGHDRI);
    /* enable LXTAL */
...
void print_calendar(uint32_t rtc_counter)
{
    ...
    LCD_ShowNum(1,1,year,4,16,RED,WHITE,1);     Show_Str(33,1,RED,WHITE,".",16,1);	
    LCD_ShowNum(37,1,month,2,16,RED,WHITE,1);   Show_Str(53,1,RED,WHITE,".",16,1);
    LCD_ShowNum(57,1,day,2,16,RED,WHITE,1); 

    LCD_ShowNum(2,16,hour,2,16,RED,WHITE,1);    Show_Str(17,15,RED,WHITE,":",16,1);
    LCD_ShowNum(24,16,minute,2,16,RED,WHITE,1); Show_Str(40,15,RED,WHITE,":",16,1);
    LCD_ShowNum(47,16,second,2,16,RED,WHITE,1);
}
